        ...
        <div className="space-y-4">
          ...
          <div className="border border-[#E2E8F0] rounded-3xl p-5 bg-white">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-[14px]">
                ...
                <span className="font-medium text-[#012b39]">Akhileswar Kamale</span>
              </div>
              <div className="flex justify-between items-center text-[14px]">
                <span className="text-[#64748B]">Email</span>
                <span className="font-medium text-[#012b39]">akhilkamale@gmail.com</span>
              </div>
              <div className="flex justify-between items-center text-[14px]">
                <span className="text-[#64748B]">Date of birth</span>
                <span className="font-medium text-[#012b39]">1998-05-27</span>
              </div>
              <div className="flex justify-between items-center text-[14px]">
                <span className="text-[#64748B]">Gender</span>
                <span className="font-medium text-[#012b39]">male</span>
              </div>
              <div className="flex justify-between items-center text-[14px]">
                <span className="text-[#64748B]">Emergency contact</span>
                <span className="font-medium text-[#012b39]">+91 9392822250</span>
              </div>
            </div>
          </div>
          ...
          <div className="border border-[#E2E8F0] rounded-3xl p-5 bg-white">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-[14px]">
                ...
                <span className="font-medium text-[#012b39]">XXXX XXXX 6342</span>
              </div>
              <div className="flex justify-between items-center text-[14px]">
                <span className="text-[#64748B]">PAN</span>
                <span className="font-medium text-[#012b39]">ABCDE4553Y</span>
              </div>
            </div>
          </div>
          ...
          <div className="border border-[#E2E8F0] rounded-3xl p-5 bg-white">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-[14px]">
                ...
                <span className="font-medium text-[#012b39]">DL-01AB-2024-1234567</span>
              </div>
              <div className="flex justify-between items-center text-[14px]">
                <span className="text-[#64748B]">Expiry date</span>
                <span className="font-medium text-[#012b39]">2026-07-31</span>
              </div>
            </div>
          </div>
          ...
          <div className="border border-[#E2E8F0] rounded-3xl p-5 bg-white">
            ...
            <div className="space-y-3">
              <div className="flex justify-between items-center text-[14px]">
                ...
                <span className="font-medium text-[#012b39]">Bengaluru, Karnataka</span>
              </div>
              <div className="flex justify-between items-center text-[14px]">
                <span className="text-[#64748B]">Area</span>
                <span className="font-medium text-[#012b39]">Indiranagar</span>
              </div>
              <div className="flex justify-between items-center text-[14px]">
                <span className="text-[#64748B]">Pincode</span>
                <span className="font-medium text-[#012b39]">560038</span>
              </div>
            </div>
          </div>
          ...
          <div className="mt-8 pb-8">
            <button
              ...
              className="w-full rounded-full py-[12px] text-[15px] transition-all bg-[#012b39] hover:bg-[#011c26] text-white active:scale-[0.98] shadow-lg"
            >
